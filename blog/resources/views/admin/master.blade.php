            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-cube fa-fw"></i> Wallet<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('/admin/wallet/list') }}">List wallet</a>
                                </li>
                                <li>
                                    <a href="{{ url('/admin/wallet/add') }}">Add wallet</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-cube fa-fw"></i> Transaction<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('/admin/wallet/list') }}">List Transaction</a>
                                </li>
                                <li>
                                    <a href="{{ url('/admin/wallet/add') }}">Add Transaction</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
